resource "databricks_mount" "adls" {
  ...
  extra_configs = {
    ...
    "fs.azure.account.oauth2.client.secret" : databricks_secret.this[data.azurerm_key_vault_secret.sp_key.name].config_reference,
    ...
    "spark.databricks.sqldw.jdbc.service.principal.client.secret" : databricks_secret.this[data.azurerm_key_vault_secret.sp_key.name].config_reference
  }
}
