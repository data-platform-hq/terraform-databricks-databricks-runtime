...
| <a name="input_mount_adls_passthrough"></a> [mount\_adls\_passthrough](#input\_mount\_adls\_passthrough)                     | Boolean flag to use mount options for credentals passthrough                                                                                                                                                                                                                                                | `bool`                                                                                                                                                                                                                                                | false                                                                                                                     |    no    |
| <a name="input_cluster_conf_passthrought"></a> [cluster\_conf\_passthrought](#input\_cluster\_conf\_passthrought)            | Boolean flag to enable credential passthrough on the cluster                                                                                                                                                                                                                                                | `bool`                                                                                                                                                                                                                                                | false                                                                                                                     |    no    |
